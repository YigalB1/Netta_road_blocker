...
module USBmini()
   {
       ...
       // this dummy cube to make larger hole for USB
       // can be removed for "real" model
       dummy_x = 11;
       dummy_y = 6;
       dummy_w = 5;
       
       translate([-5.5,-6,-1]) cube([dummy_x,dummy_y,dummy_w]);
   difference()
      {
      hull()
         {
...
/*
         // the hole inside the USB connector
         // removed because of the 3D hole needs in the box
      translate([0,-1,0])
         hull()
            {
